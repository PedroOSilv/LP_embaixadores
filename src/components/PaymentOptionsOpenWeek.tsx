      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="font-vivant-light text-lg md:text-xl text-muted-foreground mb-12 max-w-2xl mx-auto">
            Porque a tua confiança não pode esperar. Facilito o teu investimento no transplante capilar com condições únicas.
          </p>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8">
              ...
              <div className="text-center md:text-left">
                ...
                <p className="font-vivant-light text-muted-foreground">
                  Condições especiais para o teu transplante capilar com o Dr. Marcos Kawasaki
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-gold rounded-xl p-6 text-center">
            <p className="font-vivant-medium text-white text-lg mb-4">
              Não deixes o investimento ser um obstáculo à tua nova imagem
            </p>
            <p className="font-vivant-light text-white/90 text-sm mb-4">
              Consulta as condições detalhadas no teu rastreio capilar gratuito
            </p>
            <button 
...
export default PaymentOptionsOpenWeek;