        ...
        <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-3 text-left">
            ...
            <h1 className="font-vivant-black text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium text-white mb-4 md:mb-6 leading-tight tracking-tight">
              Transforme o seu Sorriso<br />
              <span className="text-transparent bg-gradient-gold bg-clip-text">
                com Facetas Dentárias
              </span>
            </h1>
            
            <p className="font-vivant-light text-lg sm:text-xl md:text-2xl text-white/90 mb-6 md:mb-8 leading-relaxed">
              Lentes de contato dental ultrafinas para um sorriso perfeito e natural em poucos dias.
            </p>

            <p className="font-vivant-light text-base md:text-lg text-white/80 mb-8 leading-relaxed">
              Correção de formato, cor e alinhamento dos dentes com tecnologia de ponta. 
              Resultado imediato e duradouro para o sorriso dos seus sonhos.
            </p>
          ...
          <div className="lg:col-span-2">
            <EvaluationForm 
              interesse="Facetas"
              webhookUrl="https://n8n.automacoesareluna.pt/webhook/LP-FACETA-DIEGO"
              description="Descubra se as facetas são ideais para você"
            />
          </div>
        </div>
      </div>
