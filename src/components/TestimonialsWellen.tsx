const TestimonialsWellen = () => {
  const testimonials = [
    {
      text: "Entrei com medo. Saí com confiança.",
      name: "Maria",
      age: "52"
    },
    {
      text: "Voltei a sorrir. Voltei a comer. Voltei a viver.",
      name: "João",
      age: "65"
    },
    {
      text: "A Wellen segurou a minha mão em cada etapa. Resultado além do que sonhei.",
      name: "Ana",
      age: "48"
    }
  ];
            ...
            <div className="text-center">
              <div className="flex items-center justify-center gap-4 mb-6">
                ...
                <div className="text-left">
                  <p className="font-vivant-medium text-foreground text-lg">Wellen Novato</p>
                  <p className="font-vivant-light text-primary text-sm">Consultora de Confiança</p>
                </div>
              </div>
              
              <blockquote className="font-vivant-light text-foreground text-lg md:text-xl leading-relaxed italic mb-2">
                "O meu maior orgulho é ver pessoas que chegam sem esperança saírem com um sorriso radiante."
              </blockquote>
              <p className="font-vivant-light text-sm text-muted-foreground">• 5 anos de experiência mudando vidas</p>
            </div>
          </div>
        </div>
      </div>
...
export default TestimonialsWellen;