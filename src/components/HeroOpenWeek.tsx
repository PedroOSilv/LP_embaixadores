  ...
  return (
    <section className="relative min-h-[70vh] md:min-h-[75vh] flex items-center overflow-hidden pt-16 md:pt-20">
      ...
      <div 
        ...
        style={{
          backgroundImage: `url('https://res.cloudinary.com/dli5oe4qg/image/upload/v1757003518/Instituto-Areluna-Clinicas-9_bvlrlg.jpg')`,
        ...
        <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-3 text-left">
            ...
            <h1 className="font-vivant-black text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium text-white mb-4 md:mb-6 leading-tight tracking-tight">
              Open Week Capilar<br />
              <span className="text-transparent bg-gradient-gold bg-clip-text">8 a 12 de Setembro</span>
            </h1>
            
            <p className="font-vivant-light text-lg sm:text-xl md:text-2xl text-white/90 mb-6 md:mb-8 leading-relaxed">
              Rastreio capilar <span className="font-bold">GRATUITO</span>
            </p>

            <p className="font-vivant-light text-base md:text-lg text-white/80 mb-8 leading-relaxed">
              Descubra a saúde do seu couro cabeludo e sobrancelhas e previna a queda de cabelo com uma clínica especializada em transplante capilar.
            </p>
          ...
          {/* Right side - Form */}
          <div className="lg:col-span-2 bg-white/10 backdrop-blur-md rounded-xl p-6 shadow-xl border border-white/20" id="evaluation-form">
            <EvaluationForm 
              interesse="Rastreio Capilar - Open Week"
              webhookUrl="https://n8n.automacoesareluna.pt/webhook/open-week-capilar"
