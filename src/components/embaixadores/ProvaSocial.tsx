...
const ProvaSocial = () => {
  ...
  const locations = [
    { country: "Portugal", icon: MapPin },
    { country: "Switzerland", icon: MapPin },
    { country: "France", icon: MapPin },
    { country: "Luxembourg", icon: MapPin },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
              We are a community of professionals, patients and influencers
              who believe in transformation through aesthetic with purpose.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-slate-400 mt-8 max-w-2xl mx-auto">
              Present in Portugal, Switzerland, France and Luxembourg, Instituto Areluna
              is recognized for excellence in integrated aesthetics and results
